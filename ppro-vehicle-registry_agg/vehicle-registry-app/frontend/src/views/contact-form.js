...
<vaadin-form-layout style="width: 100%; height: 100%;">
 <vaadin-text-field label="First name" placeholder="Enter first name here..."></vaadin-text-field>
 <vaadin-text-field label="Last name" placeholder="Enter last name here..."></vaadin-text-field>
 <vaadin-email-field placeholder="Enter email here..." label="Email"></vaadin-email-field>
